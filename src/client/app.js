...
class Interface {
  constructor() {
    ...
    this.coreYouBar = elementById('hud-core-you-bar');
    this.coreRivalBar = elementById('hud-core-rival-bar');
    this.biomassBar = elementById('hud-biomass-bar');
    this.powerBar = elementById('hud-power-bar');
  ...
  renderHud(client) {
    ...
    this.biomass.textContent = `${Math.floor(you.biomass)}/${Math.floor(sim.biomassCap)} +${sim.biomassRegenFor(you).toFixed(1)}`;
